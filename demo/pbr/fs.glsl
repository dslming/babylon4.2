...
void main(void) {
    ...
    preInfo = computeHemisphericPreLightingInfo(light1.vLightData, viewDirectionW, normalW);
    preInfo.NdotV = NdotV;
    preInfo.attenuation = 1.0;
    preInfo.roughness = roughness;
    info.diffuse = computeHemisphericDiffuseLighting(preInfo, light1.vLightDiffuse.rgb, light1.vLightGround);
    info.specular = computeSpecularLighting(preInfo, normalW, clearcoatOut.specularEnvironmentR0, specularEnvironmentR90, AARoughnessFactors.x, light1.vLightDiffuse.rgb);
