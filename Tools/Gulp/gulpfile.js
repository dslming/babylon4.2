...
// gulp.task("fullLint", gulp.series("circularDependencies"));

/**
 * Validate compile the code and check the comments and style case convention through typedoc
 */
gulp.task("typedoc-check", gulp.series("core"));
 ...
 * Do it all (Build).
 */
gulp.task("typescript-all", gulp.series("typescript-libraries"));
 ...
 */
gulp.task("default", gulp.series("typescript-all"));
