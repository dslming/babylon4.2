        ...
        if (svgDoc && svgDoc.documentElement) {
            ...
            if (vb && docwidth && docheight && elem) {
                ...
                if (elem.transform && elem.transform.baseVal.consolidate()) {
                    elem_matrix_a = (elem.transform.baseVal.consolidate() as any).matrix.a;
                    elem_matrix_d = (elem.transform.baseVal.consolidate()as any).matrix.d;
                    elem_matrix_e = (elem.transform.baseVal.consolidate()as any).matrix.e;
                    elem_matrix_f = (elem.transform.baseVal.consolidate()as any).matrix.f;
                }
